...
contract TimeLockStaking is BaseToken, ITimeLockDeposits {
    ...
    event Deposited(uint256 amount, uint256 shareAmount, uint256 duration, address indexed receiver, address indexed from);
    ...
    function withdraw(uint256 _depositId, address _receiver) external {
        require(_depositId < depositsOf[_msgSender()].length, "Deposit does not exist");
        ...
        require(balanceOf(_msgSender()) >= userDeposit.shareAmount, "User does not have enough Staking Tokens to withdraw");
        // remove Deposit
